...
from app.utils.file import add_image_watermark_docx, add_image_watermark_pdf, convert_word_to_html, delete_file, save_file
...
@doc.route("/<int:visual_id>/detail", methods=["GET", "POST"])
